...
function gotPoses(results)
{
	...
	if(results.length > 0)
	{
		...
		console.log(pulsoX + ":Horizontal " + pulsoY + ":Vertical");

    pulsoScore = results[0].pose.keypoints[8].score;
    console.log("Score do pulso Direito: " + pulsoScore);
	}
}
...
function draw(){
  ...
  if(pulsoScore > 0.2)
  {
    console.log("Circulo Vermelho");
    fill("red");
    stroke("red");
    circle(pulsoX, pulsoY, 10);
  }
}
